        ...
        <div className="lg:rounded-xl lg:border lg:border-gray-200 lg:m-5 order-1 lg:order-2 bg-top xxl:bg-center xl:bg-cover bg-no-repeat branded-bg">
          <div className="flex flex-col p-8 lg:p-16 gap-4">
            ...
            <div className="flex flex-col gap-3">
              <h3 className="text-2xl font-semibold text-gray-900">Calles Platform</h3>
              <div className="text-base font-medium text-gray-600">
                <span className="text-gray-900 font-semibold"> Efficiency, security, and innovation</span> designed<br />
                for business management—your gateway to <br />
                agile and reliable administration.
              </div>
            </div>
          </div>
        </div>
